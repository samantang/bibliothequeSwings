 ...
 * @author salioubah
 * 
 * <b>Description:</b><i>Creer un JTabbedPane avec un bouton de fermeture </i>
 * <br/>
 */
public class MyTabbedPane extends JTabbedPane  {
    
    /**
     * Contantes pour definir l'onglet fermant.
     * WITH_CLOSE_CROSS : affiche une croix pour fermer l'onglet
     * NONE : affiche l'onglet de base d'un JTabbedPane
     */
    ...
    /**
     * 
     * @param selectedColor : couleur de l'onglet selectionne
     * @param noneSelectedColor : couleur des onglets non selectionnes
     */
    public MyTabbedPane(Color selectedColor, Color noneSelectedColor) {
        super();
    ...
    /**
     * 
     * Lance un evenement a tous les ecouteurs lorsque q'un onglet a ete ferme
     * 
     * @param tabNumber
     */
     ...
     * @param constraint : contrainte qui definit la presence de la croix de fermeture ou non
     */
     ...
     * @param component : composant que contient l'onglet
     * @param constraint : contrainte qui definit la presence de la croix de fermeture ou non
     * @param icone : icone a afficher du cote gauche du texte
     */
    ...
    private class ecouteurDeMouse extends MouseAdapter {
        public void mousePressed(MouseEvent e) {
            int tabNumber = getUI().tabForCoordinate(MyTabbedPane.this, e.getX(), e.getY());
...
class ThemeUI extends BasicTabbedPaneUI {
    ...
    public void setTabbedPane (MyTabbedPane pane) {
        this.pane = pane;
    }
